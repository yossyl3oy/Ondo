...
### Windows
Temperature and hardware data is retrieved using [LibreHardwareMonitor](https://github.com/LibreHardwareMonitor/LibreHardwareMonitor) running as a background daemon. This provides accurate sensor data for:
...
WMI (Windows Management Instrumentation) is used as a fallback when LHM data is unavailable.
